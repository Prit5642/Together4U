...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $id = $_POST['edit_id'];
    $updateQuery = "UPDATE membership_types SET type = '$membershipType', amount = $membershipAmount WHERE id = $id and clubname='$clubname'";
...
$editQuery = "SELECT * FROM membership_types WHERE id = $edit_id and clubname='$clubname'";
