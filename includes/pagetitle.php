    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                } elseif (strpos($_SERVER['REQUEST_URI'], 'admindashboard.php') !== false) {
                  $pageTitle = 'Dashboard';
                } elseif (strpos($_SERVER['REQUEST_URI'], 'announcement.php') !== false) {
                  $pageTitle = 'Announcements';
                } elseif (strpos($_SERVER['REQUEST_URI'], 'superadmindashboard.php') !== false) {
                  $pageTitle = 'Dashboard';
                }
