 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      <div class="row">
        ...
        <div class="col-9">
          <span class="brand-text font-weight-light" style="font-size: 20px;"><?php echo getSystemName(); ?></span><br>
        </div>
      </div>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            ...
            if ($_SESSION['type'] === 'admin') {
              ?>
              <a href="admindashboard.php" class="nav-link <?php echo ($current_page == 'dashboard.php') ? 'active' : ''; ?>">
              ...
              ?>
              <a href="superadmindashboard.php" class="nav-link <?php echo ($current_page == 'dashboard.php') ? 'active' : ''; ?>">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>
                  Dashboard
                </p>
          ...
          <li class="nav-item">
            <a href="announcement.php" class="nav-link <?php echo ($current_page == 'announcement.php') ? 'active' : ''; ?>">
          ...
          <li class="nav-item">
            <a href="revenue_report.php" class="nav-link <?php echo ($current_page == 'messages.php') ? 'active' : ''; ?>">
