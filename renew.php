...
$membershipTypesQuery = "SELECT id, type, amount, clubname FROM membership_types where clubname='$clubname'";
$membershipTypesResult = $conn->query($membershipTypesQuery);

if (isset($_GET['id'])) {
    $memberId = $_GET['id'];

    $fetchMemberQuery = "SELECT * FROM members WHERE id = $memberId and clubname='$clubname'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateMemberQuery = "UPDATE members SET membership_type = $membershipTypeId, expiry_date = '$expiryDate' WHERE id = $memberId and clubname='$clubname'";
