...
$membershipTypesQuery = "SELECT id, type, amount, clubname FROM membership_types";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertQuery = "INSERT INTO members (fullname, dob, gender, contact_number, email, address, country, postcode, occupation, 
                    membership_type, membership_number, photo, created_at, clubname) 
                    VALUES ('$fullname', '$dob', '$gender', '$contactNumber', '$email', '$address', '$country', '$postcode', '$occupation', 
                            '$membershipType', '$membershipNumber', '$uniquePhotoName', NOW(), '$clubname')";
