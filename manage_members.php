...
$selectQuery = "SELECT * FROM members where clubname='$clubname' ORDER BY created_at DESC";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $clubname = $_SESSION['clubname'];
    $insertQuery = "INSERT INTO membership_types (type, amount, clubname) VALUES ('$membershipType', $membershipAmount, '$clubname')";
